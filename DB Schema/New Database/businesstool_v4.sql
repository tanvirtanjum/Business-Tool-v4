...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2020 at 01:24 PM
...
('L101F', 'lll', 'Laptop', 'AVAILABLE', 8, 15000.00, 16000.00, '1', '2020-08-13 15:18:23'),
('L102F', 'sf', 'Laptop', 'AVAILABLE', 111, 1500.00, 1600.00, 'A1', '2020-08-13 16:38:34'),
...
--
ALTER TABLE `sales`
  MODIFY `SLID` int(254) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
